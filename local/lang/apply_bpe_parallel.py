...
def create_parser():
    ...
    parser.add_argument("--nj", type=int, default=4, metavar="INT", help="Number of jobs")
...
class Tokenizer:
    ...
    def __call__(self, line):
        return self.bpe.process_line(line=line)
...
if __name__ == '__main__':
    ...
    with Pool(args.nj) as p:
        for line in p.imap(Tokenizer(bpe), args.input, chunksize=4096):
